...
export const metadata = {
  title: "Admin Dashboard | Sidago CRM",
  description: "Admin dashboard for Sidago CRM.",
  robots: {
    index: false,
    follow: false,
  },
      ...
      <main className="min-h-full p-6 md:p-8">
        <section className="rounded-3xl border border-slate-200/80 bg-white/80 p-8 shadow-xl shadow-slate-200/60 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/70 dark:shadow-black/20">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 dark:text-slate-300">
            Admin users can access every protected route. This dashboard is the
            dedicated landing page after admin sign-in.
          </p>
          <div className="mt-8">
            <Link

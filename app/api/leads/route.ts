...
export async function GET() {
  ...
  const url = `https://api.airtable.com/v0/appsYLUc51HNGLNcO/tblZYbsE94C8WIXcf?view=Call%20UI%20-%20Mariz&${fieldParams}&maxRecords=100`;
  const url2 = `https://api.airtable.com/v0/appsYLUc51HNGLNcO/tblZYbsE94C8WIXcf?view=Call%20UI%20-%20Bryan&${fieldParams}&maxRecords=100`;
  try {
